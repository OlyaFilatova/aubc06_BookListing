...
public class QueryUtils {
    ...
    /**
     * Takes request url and returns list of Books
     *
     * @param baseUrl
     * @return
     */
     ...
     *
     * @param requestUrl request string to fetch data
     * @return
     */
    ...
    /**
     * Reads data that we got from server and returns it as a string
     *
     * @param inputStream
     * @return data that we got from server
     */
     ...
     *
     * @param url URL to connect to server
     * @return result that we got from server or empty string if response code wasn't 200
     * @throws IOException
     */
    ...
    /**
     * Extract Book data from json string
     *
